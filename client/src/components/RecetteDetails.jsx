                                    ...
                                    <div className="relative top-10 mx-auto p-5 border w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
                                        <div className="mt-3 text-center">
                                            ...
                                            <div className="flex justify-around items-center mt-4">
                                                ...
                                                >
                                                    <svg
                                                        xmlns="https://icons8.com/icon/20909/whatsapp"
                                                        width="24"
                                                        height="24"
                                                        viewBox="0 0 24 24"
                                                        fill="currentColor"
                                                    >
                                                        <path d="M12 0C5.37 0 0 5.37 0 12C0 17.64 3.87 22.5 9 23.74L6.75 24L7.5 21.75C7.58 21.37 7.62 20.98 7.62 20.59C7.62 16.8 10.2 14.04 13.5 14.04C14.73 14.04 15.96 14.34 17.04 14.94C18.15 15.54 19.05 16.44 19.65 17.55C20.25 18.66 20.55 19.89 20.55 21.12C20.55 21.21 20.55 21.3 20.54 21.39C20.52 21.87 20.4 22.35 20.16 22.79C19.92 23.23 19.57 23.62 19.13 23.94C18.69 24.26 18.17 24.5 17.61 24.64C17.05 24.78 16.46 24.83 15.87 24.79C11.16 24.38 7.12 20.34 6.71 15.63C6.67 15.05 6.91 14.47 7.33 14.03C7.75 13.59 8.33 13.35 8.91 13.39C9.5 13.43 10.08 13.75 10.5 14.31C10.92 14.87 11.13 15.62 11.08 16.38C11.04 17.16 10.74 17.91 10.2 18.5C9.66 19.09 8.91 19.5 8.13 19.54C7.35 19.58 6.6 19.28 6 18.74C5.4 18.2 5.04 17.45 5 16.67C4.96 15.89 5.26 15.14 5.8 14.55C6.34 13.96 7.09 13.55 7.87"></path>
                                                    </svg>
                                                </button>
                                            </div>
                                            <div className="items-center px-4 py-3">
